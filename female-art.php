...
<body>
  ...
  <section class="hero female-fertility-cover margin-adjust">
  ...
  <div class="accordion" id="artAccordion">
    ...
    <div class="accordion-item">
      <h2 class="accordion-header" id="heading1">
        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#ivf2" aria-expanded="true" aria-controls="ivf2">
          🧪 In Vitro Fertilization (IVF)
        </button>
      </h2>
      <div id="ivf2" class="accordion-collapse collapse show" aria-labelledby="heading1" data-bs-parent="#artAccordion">
