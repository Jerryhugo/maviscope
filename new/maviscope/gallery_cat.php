...
<?php  include "partials/navbar.php" ?>
    ...
    foreach ($images as $image) { ?>
           <a class="col-12 col-md-4 col-lg-3 m-0 p-0" href="img/gallery/<?= $image['img_name'] ?>" data-lg-size="1600-2400">
                <img class="w-100" alt="img1" src="img/gallery/<?= $image['img_name'] ?>" />
            </a>
 <?php   }
