                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-4">
                            <!-- Form -->
                            <form action="functions/insert.php?type=gallery_category" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="catImage">Category Image (2mb max) <?php if (isset($_SESSION['img-update'])) {
