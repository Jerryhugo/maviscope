...
<body class="">
    ...
    <section id="about" class="my-5" data-aos="fade-up" data-aos-duration="500">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <h1>About</h1>
                <p class="mobile-text">At Maviscope Hospital and Fertility center, we are proud to be the best fertility center in Benin City and one of the top fertility hospitals in Nigeria </p>

                <p class="desktop-text">At Maviscope Hospital and Fertility Centre, we are proud to be the best fertility center in Benin City and one of the top fertility hospitals in Nigeria. We are committed to helping individuals and couples achieve their dream of parenthood through world-class reproductive treatments. <br> <br>

                    Our cutting-edge fertility services combine medical expertise with advanced technology to offer personalized and effective care. The Best Fertility Services in Benin City and Nigeria... </p>
    ...
    <section id="services" class="my-5" >
                ...
                <a href="#">
                    <div class="services-cover">
                        <a href="OnG-service.php">
                            <img src="img/ong.jpg" alt="Obstetrics and gynecology">
                            <div class="d-flex  align-items-center">
                                <h5 class="services-text m-0">Obstetrics Ans gynecology</h5>
        ...
        <a href="services.php" class="btn btn-light-red" data-aos="fade-up" data-aos-duration="500">View All services</a>
    </section>
        ...
        <div class="swiper">
            ...
            <div class="swipper swiper-wrapper my-4">
                ...
                <div class="swiper-slide col-lg-4 col-md-6 my-4 h-100 ">
                    <div class="content bg-white mx-2 rounded p-4 text-center">

                        <!-- <img src="img/about-ivf-2.jpg" alt="img"> -->
                        <p class="mt-3 mb-2">My cousin and I have being there and God use MAVISCOPE HOSPITAL AND FERTILITY CENTER to answer her prayers today she is a happy woman God bless you sir and your team.</p>
                ...
                <div class="swiper-slide col-lg-4 col-md-6 my-4 h-100 ">
                    <div class="content bg-white mx-2 rounded p-4 text-center">
                        ...
                        <!-- <img src="img/about-ivf-2.jpg" alt="img"> -->
                        <p class="mt-3 mb-2">One of the best gynecological hospital in Edo state, guiding women through safemother hood, reducing maternal and neonatal mortality. It should be your first choice when it comes to health.</p>
                ...
                <div class="swiper-slide col-lg-4 col-md-6 my-4 h-100 ">
                    <div class="content bg-white mx-2  rounded p-4 text-center">
                        ...
                        <!-- <img src="img/about-ivf-2.jpg" alt="img"> -->
                        <p class="mt-3 mb-2">The best hospital to run to while having any health issues... A place where u can get d Best IVF and Endoscopic surgery in benin city</p>
                ...
                <div class="swiper-slide col-lg-4 col-md-6 my-4 h-100 ">
                    <div class="content bg-white mx-2 rounded p-4 text-center">
                        ...
                        <!-- <img src="img/about-ivf-2.jpg" alt="img"> -->
                        <p class="mt-3 mb-2">Well done Dr Eboh and the entire IVF team..My wife and I really appreciate the smile you have put on our face.</p>
                ...
                <div class="swiper-slide col-lg-4 col-md-6 my-4 h-100 ">
                    <div class="content bg-white mx-2 rounded p-4 text-center">
                        ...
                        <!-- <img src="img/about-ivf-2.jpg" alt="img"> -->
                        <p class="mt-3 mb-2">I would say its the best fertility center in Edo state for IVF, IUI and OI staffs are very polite and response to patients is very swift.</p>
                ...
                <div class="swiper-slide col-lg-4 col-md-6 my-4 h-100 ">
                    <div class="content bg-white mx-2 rounded p-4 text-center">
                        ...
                        <!-- <img src="img/about-ivf-2.jpg" alt="img"> -->
                        <p class="mt-3 mb-2">The best amongst the best.. One hospital with Modern infrastructures,offers Intensive health care services and Fertility treatment.</p>
                ...
                <div class="swiper-slide col-lg-4 col-md-6 my-4 h-100 ">
                    <div class="content bg-white mx-2 rounded p-4 text-center">
                        ...
                        <!-- <img src="img/about-ivf-2.jpg" alt="img"> -->
                        <p class="mt-3 mb-2">It's the best Fertility center you can ever ask for and 100% customer friendly.</p>
                ...
                <div class="swiper-slide col-lg-4 col-md-6 my-4 h-100 ">
                    <div class="content bg-white mx-2 rounded mx-2 p-4 text-center">

                        <!-- <img src="img/about-ivf-2.jpg" alt="img"> -->
                        <p class="mt-3 mb-2">An exceptional Fertility clinic with amazing results in IVF and other aspects of health care</p>
    ...
    <section data-aos="fade-up" data-aos-duration="500">
        <div class="faq-container">
            ...
            <div class="faq-item">
                ...
                <p class="faq-answer">Maviscope Hospital specializes in comprehensive fertility treatments, including In Vitro Fertilization (IVF), Intrauterine Insemination (IUI), egg donation, surrogacy, and fertility preservation. We also provide obstetric and gynecological care, general healthcare, and neonatal intensive care (NICU) services.</p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">Do I need a referral to visit the fertility centre?</h3>
                <p class="faq-answer">No, you do not need a referral to visit us. You can book an appointment directly with our specialists. However, if you have a referral from your doctor, you are welcome to bring it along.</p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">How do I book an appointment?</h3>
                <p class="faq-answer">You can <a href="booking.php"><b>book an appointment</b></a> online through our website, call us +2347038538424 or +234702 633 7952 or visit our hospital.</p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">How do I know if I need fertility treatment?</h3>
                <p class="faq-answer">If you have been trying to conceive for over a year (or six months if you are over 35) without success, we recommend booking a consultation with our fertility specialists. Other signs, such as irregular menstrual cycles or previous reproductive health issues, may also indicate the need for evaluation. <a href="booking.php"><b>Book a consultation now</b></a></p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">What fertility tests do you offer?</h3>
                <p class="faq-answer">We offer a wide range of diagnostic tests, including hormonal tests, semen analysis, ovarian reserve testing, ultrasound scans, hysterosalpingography (HSG), and genetic screenings to assess fertility health.</p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">What is the success rate of IVF at Maviscope Hospital?</h3>
                <p class="faq-answer">Success rates depend on factors such as age, medical history, and the cause of infertility. At Maviscope, we maintain competitive success rates in line with international fertility standards. Our specialists will assess your individual case and discuss realistic expectations with you.</p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">How long does the IVF process take?</h3>
                <p class="faq-answer">A complete IVF cycle typically takes about 4 to 6 weeks, including ovarian stimulation, egg retrieval, fertilization, and embryo transfer. However, the timeline may vary based on individual treatment plans.</p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">Is IVF painful?</h3>
                <p class="faq-answer">Most patients experience only mild discomfort during the ovarian stimulation and egg retrieval procedures. Anesthesia is used during egg retrieval to ensure comfort. Any discomfort after the procedure is usually mild and short-lived</p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">Can I choose the gender of my baby during IVF?</h3>
                <p class="faq-answer">Gender selection is possible through Preimplantation Genetic Testing (PGT), but it is subject to legal and ethical considerations. Our specialists can provide more details based on your needs.
            ...
            <div class="faq-item">
                ...
                <p class="faq-answer">Yes, we have a well-established egg donation program for individuals and couples who need donor eggs to conceive. Our donors are rigorously screened for medical and genetic conditions. <br>
            ...
            <div class="faq-item">
                ...
                <p class="faq-answer">Our surrogacy program supports intended parents through every stage, from legal agreements to matching with a surrogate and providing medical care throughout the pregnancy. Our team will guide you through the entire process.</p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">Who can be an egg donor or a surrogate?</h3>
                <p class="faq-answer">Egg donors are usually healthy women between 21-27 years with good ovarian reserve. Surrogates must be in good health, have had at least one successful pregnancy, and meet medical screening criteria. <a href="booking.php">Contact us here</a>
                </p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">Do you offer antenatal and postnatal care?</h3>
                <p class="faq-answer">Yes, we provide comprehensive antenatal and postnatal care, including prenatal screenings, ultrasounds, delivery services, and postpartum support.</p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">What delivery options do you offer?</h3>
                <p class="faq-answer">We provide vaginal deliveries, cesarean sections (C-sections), and high-risk pregnancy management. Our NICU is available for specialized newborn care if needed.
                </p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">How much does IVF cost at Maviscope Hospital and Fertility Centre?</h3>
                <p class="faq-answer">The cost of IVF varies depending on the specific treatment plan. We provide transparent pricing and offer payment plans to make fertility treatment more accessible. Please contact us for a personalized quote.</p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">Do you offer financing or installment payment plans for fertility treatments?</h3>
                <p class="faq-answer">Yes, we offer flexible payment plans to help make treatments more affordable. Visit the hospital and after consultation you'd be directed to speak with our finance team for more details on available options.</p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">What can I do to improve my fertility naturally?</h3>
                <p class="faq-answer">Maintaining a healthy weight, eating a balanced diet, reducing stress, avoiding smoking and excessive alcohol consumption, and exercising regularly can help improve fertility.
                </p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">Can stress affect my chances of getting pregnant?</h3>
                <p class="faq-answer">Yes, high-stress levels can impact ovulation and overall reproductive health. We offer counseling and support services to help manage stress during fertility treatments.</p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">Does age affect fertility in both men and women?</h3>
                <p class="faq-answer">Yes, fertility declines with age, especially for women after age 35. Men also experience a gradual decline in sperm quality with age. Early fertility assessment and intervention can improve success rates </p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">What should I do in case of a medical emergency related to pregnancy or fertility treatment?</h3>
                <p class="faq-answer">If you experience severe abdominal pain, heavy bleeding, or any other concerning symptoms, please call our emergency line at +2347026337952 or visit the hospital immediately.</p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">Can I get a second opinion at Maviscope Hospital?</h3>
                <p class="faq-answer">Yes, we encourage second opinions. If you have already undergone fertility treatments elsewhere and need another expert’s perspective, our specialists are available to review your case.</p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">How can I stay updated with news and health tips from Maviscope Hospital?</h3>
                <p class="faq-answer">Follow us on our social media pages and subscribe to our newsletter for the latest updates, fertility tips, and hospital announcements.</p>
            </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        toggleButtons.forEach(button => {
            button.addEventListener("click", function() {
                let moreText = this.previousElementSibling.querySelector(".more-text");
