...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
        ...
        <div class=" mx-3">Admin <sup></sup></div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseAppointments" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="appointments.php">Pending</a>
                <a class="collapse-item" href="completed_appointments.php">Completed</a>
                <a class="collapse-item" href="online_appointments.php">Online appointments</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseGallery" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <!-- <h6 class="collapse-header">Custom Components:</h6> -->
                <a class="collapse-item" href="add_gallery_img.php">Add Images</a>
                <a class="collapse-item" href="add_gallery_cat.php">Add Category</a>
                <a class="collapse-item" href="view_img_category.php">View Category</a>
                <a class="collapse-item" href="all_images.php">View Images</a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <!-- <h6 class="collapse-header">Custom Components:</h6> -->
                <a class="collapse-item" href="add_article.php">Add Post</a>
                <a class="collapse-item" href="article.php">All Posts</a>
                <a class="collapse-item" href="add_category.php">Add Category</a>
                <a class="collapse-item" href="categories.php">All Categories</a>
                <a class="collapse-item" href="add_author.php">Add Author</a>
                <a class="collapse-item" href="author.php">All Authors</a>
